...
const TextOverview = ({ eventName, eventDate }) => {
  return (
    <View style={{ paddingTop: 100, paddingLeft: 10, paddingRight: 10 }}>
      ...
      <View>
        <Text style={{ color: '#fff', fontSize: 25, paddingTop: 10 }}>{Helper.daysSincePost(eventDate)} days left</Text>
      </View>
      <View>
        <Text style={{ color: '#fff', fontSize: 18, paddingTop: 10 }}>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
